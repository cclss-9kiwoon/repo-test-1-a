...
export class SceneManager {
  ...
  registerScene(name, weatherScene) {
    this.weatherScenes[name] = weatherScene;
    weatherScene.init();
  }
  ...
  switchScene(name) {
    ...
    this.previousSceneName = this.activeSceneName;
  ...
  dispose() {
    Object.values(this.weatherScenes).forEach(s => s.dispose());
